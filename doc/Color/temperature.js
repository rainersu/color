...
* @see {@link https://github.com/neilbartlett/color-temperature}
...
* @returns {Color} 
* @example
* console.log(Color.temperature( 1000).css(0));   // #FF3A00
* console.log(Color.temperature(40000).css(0));   // #9CBDFF
*/