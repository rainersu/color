...
* @returns {Color} 
* @example
* console.log(Color('hsl(180, 100%, 50%)').match().css(0));          // #000000
* console.log(Color('#FC3').match('#CF3', '#C3F', '#3FC').css(0));   // #CC33FF
* @example
* var girl = Color('snow');
* var boys = [ 'silver', 'black', 'white' ];
* console.log(girl.match(boys).css(0));   // #000000
*/